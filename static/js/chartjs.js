...
!function (t, e) {
    ...
    class Ks extends Bs {
        ...
        update(t, e, i) {
            ...
            this._convertTicksToLabels(r ? $s(this.ticks, a) : this.ticks), this.configure(), this.beforeCalculateLabelRotation(), this.calculateLabelRotation(), this.afterCalculateLabelRotation(), o.display && (o.autoSkip || "auto" === o.source) && (this.ticks = Ns(this, this.ticks), this._labelSizes = null, this.afterAutoSkip()), r && this._convertTicksToLabels(this.ticks), this.beforeFit(), this.fit(), this.afterFit(), this.afterUpdate()
        }
        ...
        calculateLabelRotation() {
            ...
            o = t.offset ? this.maxWidth / i : u / (i - 1), c + 6 > o && (o = u / (i - (t.offset ? .5 : 1)), a = this.maxHeight - Us(t.grid) - e.padding - Xs(t.title, this.chart.options.font), r = Math.sqrt(c * c + d * d), l = Y(Math.min(Math.asin(J((h.highest.height + 6) / o, -1, 1)), Math.asin(J(a / r, -1, 1)) - Math.asin(J(d / r, -1, 1)))), l = Math.max(s, Math.min(n, l))), this.labelRotation = l
        }
            ...
            if (o) {
                ...
                if (a ? (t.width = this.maxWidth, t.height = Us(n) + o) : (t.height = this.maxHeight, t.width = Us(n) + o), i.display && this.ticks.length) {
                    const {
                            ...
                            widest: n,
                            highest: o
                        } = this._getLabelSizes(), r = 2 * i.padding, l = $(this.labelRotation), h = Math.cos(l),
                        c = Math.sin(l);
                    if (a) {
        ...
        _computeLabelSizes(t, e, i) {
            const {
                ctx: o,
                _longestTextCache: a
            } = this, r = [], l = [], h = Math.floor(e / js(e, i));
            ...
            for (c = 0; c < e; c += h) {
                if (g = t[c].label, p = this._resolveTickFontOptions(c), o.font = m = p.string, b = a[m] = a[m] || {
                    ...
                    if (n(g))
                        for (d = 0, f = g.length; d < f; ++d) v = g[d], s(v) || n(v) || (_ = De(o, b.data, b.gc, _, v), y += x)
        ...
        _computeGridLineItems(t) {
            ...
            for (_ = 0; _ < d; _ += T) {
                ...
                y = Ys(this, _, h), void 0 !== y && (v = Oe(i, y, o), c ? M = k = P = C = v : w = S = D = O = v, f.push({
                    tx1: M,
                    ty1: w,
                    tx2: k,
                    ty2: S,
    ...
    class Zs {
        constructor() {
            this.controllers = new Gs(Vs, "datasets", !0), this.elements = new Gs(Bs, "elements"), this.plugins = new Gs(Object, "plugins"), this.scales = new Gs(Ks, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
        }
    ...
    class wn {
        ...
        render() {
            !1 !== this.notifyPlugins("beforeRender", {
                cancelable: !0
            }) && (xt.has(this) ? this.attached && !xt.running(this) && xt.start(this) : (this.draw(), bn({
                chart: this
            })))
        }
    ...
    var Vn = Object.freeze({
        ...
        BarController: class extends Vs {
            ...
            _calculateBarValuePixels(t) {
                ...
                } = this, r = o || 0, l = this.getParsed(t), h = l._custom, c = Tn(h);
                let d, u, f = l[e.axis],
                    g = 0,
        ...
        const e = Qn(t),
            ...
            a = function (t, e, i) {
                const {
                    ...
                    } = t.getProps(["enableBorderRadius"]), n = t.options.borderRadius, a = vi(n), r = Math.min(e, i),
                    l = t.borderSkipped, h = s || o(n);
                return {
    ...
    class ho extends Ks {
        ...
        buildTicks() {
            ...
            const n = function (t, e) {
                ...
                for (b && (u && M !== a ? (i.push({
                    value: a
                }), M < a && D++, V(Math.round((M + D * S) * v) / v, a, lo(a, y, t)) && D++) : M < a && D++); D < k; ++D) i.push({
    ...
    class bo extends Ks {
        ...
        determineDataLimits() {
            ...
            this.min = a(t) ? Math.max(0, t) : null, this.max = a(e) ? Math.max(0, e) : null, this.options.beginAtZero && (this._zero = !0), this._zero && this.min !== this._suggestedMin && !a(this._userMin) && (this.min = t === fo(this.min, 0) ? fo(this.min, -1) : fo(this.min, 0)), this.handleTickRangeOptions()
        }
    ...
    class Po extends ho {
        ...
        generateTickLabels(t) {
            ho.prototype.generateTickLabels.call(this, t), this._pointLabels = this.getLabels().map(((t, e) => {
            ...
            if (e.pointLabels.display && function (t, e) {
                ...
                if (0 !== e) {
                    ...
                    !function (t, e, i, s, n) {
                        ...
                        !a && !s || !r || !l || i < 0 || (o.save(), o.strokeStyle = r, o.lineWidth = l, o.setLineDash(n.dash), o.lineDashOffset = n.dashOffset, o.beginPath(), So(t, i, a, s), o.closePath(), o.stroke(), o.restore())
                    }(this, s, l, a, r)
                }
            })), i.display) {
    ...
    class Ro extends Ks {
        ...
        buildTicks() {
            ...
            }(this._unit) : void 0, this.initOffsets(s), t.reverse && o.reverse(), Eo(this, o, this._majorUnit)
        }
        ...
        _generate() {
            ...
            return d !== i && "ticks" !== s.bounds && 1 !== u || Lo(c, d, g), Object.keys(c).sort(((t, e) => t - e)).map((t => +t))
        }
    ...
    function na(t, e, i) {
        ...
        s && n.points.length && (Re(t, i), function (t, e) {
            ...
            t.save(), "x" === l && o !== n && (oa(t, s, a.top), aa(t, {
                line: i,
                target: s,
                color: n,
                scale: r,
                property: l
            }), t.restore(), t.save(), oa(t, s, a.bottom));
            aa(t, {
                line: i,
                target: s,
                color: o,
    ...
    class da extends Bs {
        ...
        _draw() {
            ...
            const {
                ...
                boxHeight: p,
                itemHeight: m
            } = ca(o, d), b = this.isHorizontal(), x = this._computeTitleHeight();
            f = b ? {
    ...
    class Ta extends Bs {
        ...
        getTitle(t, e) {
            const {
                callbacks: i
            } = e, s = Aa(i, "beforeTitle", this, t), n = Aa(i, "title", this, t), o = Aa(i, "afterTitle", this, t);
            let a = [];
        ...
        getFooter(t, e) {
            const {
                callbacks: i
            } = e, s = Aa(i, "beforeFooter", this, t), n = Aa(i, "footer", this, t), o = Aa(i, "afterFooter", this, t);
            let a = [];
            return a = _a(a, ya(s)), a = _a(a, ya(n)), a = _a(a, ya(o)), a
        }
        ...
        drawTitle(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Pa(this, i.titleAlign, i), e.textAlign = l.textAlign(i.titleAlign), e.textBaseline = "middle", o = wi(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = o.string, r = 0; r < n; ++r) e.fillText(s[r], l.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + a, r + 1 === n && (t.y += i.titleMarginBottom - a)
            }
        }
        ...
        drawBody(t, e, i) {
            ...
            const g = Di(i.rtl, this.x, this.width),
                ...
                m = g.textAlign(o);
            let b, x, _, y, v, M, w;
            for (e.textAlign = o, e.textBaseline = "middle", e.font = c.string, t.x = Pa(this, m, i), e.fillStyle = i.bodyColor, u(this.beforeBody, p), f = a && "right" !== m ? "center" === o ? l / 2 + h : l + 2 + h : 0, y = 0, M = s.length; y < M; ++y) {
        ...
        drawFooter(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Pa(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = r.textAlign(i.footerAlign), e.textBaseline = "middle", o = wi(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a) e.fillText(s[a], r.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + i.footerSpacing
            }
        }
        ...
        _positionChanged(t, e) {
            const {
                ...
                caretY: s,
                options: n
            } = this, o = xa[n.position].call(this, t, e);
